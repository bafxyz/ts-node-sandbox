...
`
export function useSimplePokemon(baseOptions?: ReactApolloHooks.QueryHookOptions<SimplePokemonVariables>) {
    return ReactApolloHooks.useQuery<SimplePokemonQuery, SimplePokemonVariables>(SimplePokemonDocument, baseOptions)
}
...
`
export function usePokemon(baseOptions?: ReactApolloHooks.QueryHookOptions<PokemonVariables>) {
    return ReactApolloHooks.useQuery<PokemonQuery, PokemonVariables>(PokemonDocument, baseOptions)
}
...
`
export function useTodos(baseOptions?: ReactApolloHooks.QueryHookOptions<TodosVariables>) {
    return ReactApolloHooks.useQuery<TodosQuery, TodosVariables>(TodosDocument, baseOptions)
}
...
export function useToggleTodoComplete(
    baseOptions?: ReactApolloHooks.MutationHookOptions<ToggleTodoCompleteMutation, ToggleTodoCompleteVariables>
) {
    return ReactApolloHooks.useMutation<ToggleTodoCompleteMutation, ToggleTodoCompleteVariables>(
        ToggleTodoCompleteDocument,
        baseOptions
    )
}
...
`
export function usePokemons(baseOptions?: ReactApolloHooks.QueryHookOptions<PokemonsVariables>) {
    return ReactApolloHooks.useQuery<PokemonsQuery, PokemonsVariables>(PokemonsDocument, baseOptions)
}
...
export interface SetUserTypeMutationArgs {
...
export interface QueryResolvers<TContext = MyContext, TypeParent = {}> {
    ...
    pokemons?: QueryPokemonsResolver<Maybe<(Maybe<Pokemon>)[]>, TypeParent, TContext>
    ...
    getUserType?: QueryGetUserTypeResolver<Maybe<string>, TypeParent, TContext>
}

export type QueryQueryResolver<R = Maybe<Query>, Parent = {}, TContext = MyContext> = Resolver<R, Parent, TContext>
export type QueryPokemonsResolver<R = Maybe<(Maybe<Pokemon>)[]>, Parent = {}, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext,
    QueryPokemonsArgs
...
export type QueryPokemonResolver<R = Maybe<Pokemon>, Parent = {}, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext,
    QueryPokemonArgs
...
export type QueryTodosResolver<R = Maybe<Todo>, Parent = {}, TContext = MyContext> = Resolver<R, Parent, TContext>
export type QueryGetUserTypeResolver<R = Maybe<string>, Parent = {}, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
...
export interface PokemonResolvers<TContext = MyContext, TypeParent = Pokemon> {
    ...
    /** The classification of this Pokémon */
    classification?: PokemonClassificationResolver<Maybe<string>, TypeParent, TContext>
    /** The type(s) of this Pokémon */
    types?: PokemonTypesResolver<Maybe<(Maybe<string>)[]>, TypeParent, TContext>
    /** The type(s) of Pokémons that this Pokémon is resistant to */
    resistant?: PokemonResistantResolver<Maybe<(Maybe<string>)[]>, TypeParent, TContext>
    /** The attacks of this Pokémon */
    attacks?: PokemonAttacksResolver<Maybe<PokemonAttack>, TypeParent, TContext>
    /** The type(s) of Pokémons that this Pokémon weak to */
    weaknesses?: PokemonWeaknessesResolver<Maybe<(Maybe<string>)[]>, TypeParent, TContext>
    ...
    /** The evolutions of this Pokémon */
    evolutions?: PokemonEvolutionsResolver<Maybe<(Maybe<Pokemon>)[]>, TypeParent, TContext>
    /** The evolution requirements of this Pokémon */
    ...
    isMaxHPDivisibleByCount?: PokemonIsMaxHpDivisibleByCountResolver<boolean, TypeParent, TContext>

    randomPerson?: PokemonRandomPersonResolver<Maybe<Person>, TypeParent, TContext>

    isFavorite?: PokemonIsFavoriteResolver<Maybe<boolean>, TypeParent, TContext>
}

export type PokemonIdResolver<R = string, Parent = Pokemon, TContext = MyContext> = Resolver<R, Parent, TContext>
export type PokemonNumberResolver<R = Maybe<string>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonNameResolver<R = Maybe<string>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonWeightResolver<R = Maybe<PokemonDimension>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonHeightResolver<R = Maybe<PokemonDimension>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonClassificationResolver<R = Maybe<string>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonTypesResolver<R = Maybe<(Maybe<string>)[]>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonResistantResolver<R = Maybe<(Maybe<string>)[]>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonAttacksResolver<R = Maybe<PokemonAttack>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonWeaknessesResolver<R = Maybe<(Maybe<string>)[]>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonFleeRateResolver<R = Maybe<number>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonMaxCpResolver<R = Maybe<number>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonEvolutionsResolver<R = Maybe<(Maybe<Pokemon>)[]>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
...
export type PokemonMaxHpResolver<R = Maybe<number>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonImageResolver<R = Maybe<string>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonIsMaxHpOddResolver<R = boolean, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonIsMaxHpDivisibleByCountResolver<R = boolean, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonRandomPersonResolver<R = Maybe<Person>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PokemonIsFavoriteResolver<R = Maybe<boolean>, Parent = Pokemon, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
/** Represents a Pokémon's dimensions */
export interface PokemonDimensionResolvers<TContext = MyContext, TypeParent = PokemonDimension> {
    /** The minimum value of this dimension */
    minimum?: PokemonDimensionMinimumResolver<Maybe<string>, TypeParent, TContext>
    /** The maximum value of this dimension */
    maximum?: PokemonDimensionMaximumResolver<Maybe<string>, TypeParent, TContext>
}
...
> = Resolver<R, Parent, TContext>
/** Represents a Pokémon's attack types */
export interface PokemonAttackResolvers<TContext = MyContext, TypeParent = PokemonAttack> {
    /** The fast attacks of this Pokémon */
    fast?: PokemonAttackFastResolver<Maybe<(Maybe<Attack>)[]>, TypeParent, TContext>
    /** The special attacks of this Pokémon */
    special?: PokemonAttackSpecialResolver<Maybe<(Maybe<Attack>)[]>, TypeParent, TContext>
}
...
export type AttackNameResolver<R = Maybe<string>, Parent = Attack, TContext = MyContext> = Resolver<R, Parent, TContext>
export type AttackTypeResolver<R = Maybe<string>, Parent = Attack, TContext = MyContext> = Resolver<R, Parent, TContext>
export type AttackDamageResolver<R = Maybe<number>, Parent = Attack, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
/** Represents a Pokémon's requirement to evolve */
export interface PokemonEvolutionRequirementResolvers<TContext = MyContext, TypeParent = PokemonEvolutionRequirement> {
    /** The amount of candy to evolve */
    amount?: PokemonEvolutionRequirementAmountResolver<Maybe<number>, TypeParent, TContext>
    /** The name of the candy to evolve */
    name?: PokemonEvolutionRequirementNameResolver<Maybe<string>, TypeParent, TContext>
}
...
export type PersonGenderResolver<R = Maybe<string>, Parent = Person, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
export type PersonNameResolver<R = Maybe<Name>, Parent = Person, TContext = MyContext> = Resolver<R, Parent, TContext>
...
export type NameTitleResolver<R = Maybe<string>, Parent = Name, TContext = MyContext> = Resolver<R, Parent, TContext>
export type NameFirstResolver<R = Maybe<string>, Parent = Name, TContext = MyContext> = Resolver<R, Parent, TContext>
export type NameLastResolver<R = Maybe<string>, Parent = Name, TContext = MyContext> = Resolver<R, Parent, TContext>
...
export type TodoIdResolver<R = string, Parent = Todo, TContext = MyContext> = Resolver<R, Parent, TContext>
export type TodoTextResolver<R = Maybe<string>, Parent = Todo, TContext = MyContext> = Resolver<R, Parent, TContext>
export type TodoCompleteResolver<R = Maybe<boolean>, Parent = Todo, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext
>
...
export interface MutationResolvers<TContext = MyContext, TypeParent = {}> {
    ...
    toggleTodoComplete?: MutationToggleTodoCompleteResolver<Maybe<boolean>, TypeParent, TContext>

    setUserType?: MutationSetUserTypeResolver<Maybe<string>, TypeParent, TContext>
}
...
export type MutationIncrementResolver<R = Maybe<number>, Parent = {}, TContext = MyContext> = Resolver<
    ...
    TContext
>
export type MutationToggleTodoCompleteResolver<R = Maybe<boolean>, Parent = {}, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext,
    MutationToggleTodoCompleteArgs
>
export interface MutationToggleTodoCompleteArgs {
    id: string
}

export type MutationSetUserTypeResolver<R = Maybe<string>, Parent = {}, TContext = MyContext> = Resolver<
    R,
    Parent,
    TContext,
    MutationSetUserTypeArgs
>
export interface MutationSetUserTypeArgs {
    userType?: Maybe<string>
}
